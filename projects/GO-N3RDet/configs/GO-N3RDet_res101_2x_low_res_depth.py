...
custom_imports = dict(imports=['projects.GO-N3RDet.go_n3r_det'])
...
model = dict(
    ...
    # test_cfg=dict(nms_pre=1000, iou_thr=.5, score_thr=.1))
dataset_type = 'MultiViewScanNetDataset'
data_root = '/data/gpfs/projects/punim2198/lzc_data/scannet/'
class_names = [
...
train_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Resize', scale=(480, 360), keep_ratio=True),
        ],
        mean=[123.675, 116.28, 103.53],
        std=[58.395, 57.12, 57.375],
        margin=10,
